// components/headers/settings/PrivacySettingsHeader.tsx
...
interface PrivacySettingsHeaderProps {
  title: string;
  navigation: any;
  route: any;
...
export const PrivacySettingsHeader: React.FC<PrivacySettingsHeaderProps> = ({
  title,
  navigation,
  route,
  backgroundColor,
